package com.example.goldyfly.ui.theme.screens.account
...
@Composable
fun AccountItem(name:String, plate:String, email:String, id:String,
    ...
    Column(modifier = Modifier
        ...
        Button(
            onClick = { navController.navigate(BOOKING_URL) },
            modifier = Modifier,
            colors = ButtonDefaults.buttonColors(newGreen),
            shape = RoundedCornerShape(10.dp)
        ) {
            Text(text = "Proceed with booking")
        }
